...
// called, not by a client-sent operation label — a client can't relabel
// this as a 1-credit call to pay less. Otherwise mirrors /api/ai/generate
// exactly, including the maxTokens passthrough the blog-write call needs.
const OPERATION = "BLOG_WRITE" as const;
const CREDITS_NEEDED = OPERATION_CREDIT_COST.BLOG_WRITE;
