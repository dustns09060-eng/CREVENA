...
export type CarouselProject = {
  ...
  // STEP42: set only when this project was generated by "이 글로 카드뉴스
  // 만들기" (repurposed from a Blog) — never set for a from-scratch AI 카드뉴스
  // 만들기, and never required by anything that reads a CarouselProject.
