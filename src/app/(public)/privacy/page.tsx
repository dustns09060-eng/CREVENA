  ...
  return (
    ...
    >
      ...
      <LegalSection heading="4. 개인정보의 보유 및 파기">
        ...
        />
        <LegalText>
          다만 <b>결제 시도·환불 기록은 탈퇴 후에도 보존됩니다.</b> 거래·회계 기록의 정합성을 유지하기 위한 것으로, 탈퇴
          시점에 해당 기록의 <b>회원 연결 정보(회원 식별자)는 제거</b>되어 더 이상 특정 회원과 연결되지 않는 상태로 남습니다.
          보존되는 항목은 결제 일시, 금액, 요금제, 결제·환불 상태, 결제대행사 거래 식별자이며, 이메일·이름 등 회원을 식별할
          수 있는 정보는 결제 기록으로 옮겨 저장하지 않습니다.
        </LegalText>
        <OperatorTodo>
