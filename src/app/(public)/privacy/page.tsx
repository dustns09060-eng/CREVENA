  ...
  return (
    ...
    >
      ...
      <LegalSection heading="4. 개인정보의 보유 및 파기">
        ...
        <LegalList
          items={[
            "업로드한 사진·영상 원본 및 썸네일 파일(저장소에서 직접 삭제)",
            "로그인 계정 정보",
        ...
        />
        <OperatorTodo>
          <b>[운영자 확인 필요]</b> 현재 구현에서는 탈퇴 시 <b>결제·환불 기록도 함께 삭제</b>되며, 항목별 보유 기간을
          정하는 로직은 없습니다. 전자상거래 등에서의 소비자보호에 관한 법률 등 관련 법령이 거래·결제 기록의 일정 기간
          보존을 요구하는 경우, 이 동작은 법령과 충돌할 수 있습니다. 정식 오픈 전에 (1) 항목별 보유 기간, 특히 법정 보존이
          필요한 결제 기록의 보존 기간과 (2) 탈퇴 시 결제 기록을 분리 보관할지 여부를 법률 검토를 거쳐 확정하고, 이 항목과
          실제 구현에 함께 반영해야 합니다. 사실과 다른 보유 기간을 임의로 적지 않았습니다.
        </OperatorTodo>
      </LegalSection>
